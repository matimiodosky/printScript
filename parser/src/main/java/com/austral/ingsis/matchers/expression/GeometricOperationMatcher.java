...
public class GeometricOperationMatcher extends ExpressionMatcher<Operation> {


    public GeometricOperationMatcher(ExpressionParser expressionMatcher) {
    ...
    public Optional<Operation> match(Stream<Token> tokenStream) {
        ...
        int plus = tokensTypes.indexOf(TokenType.DIV);
        int minus = tokensTypes.indexOf(TokenType.MULT);
        int operator = -1;
